...
import os
import sys
gSystem.CompileMacro("oldToys.C", "gOck")
gSystem.Load("oldToys_C")
...
def main():
    ...
    parser.add_argument("-p", "--npoints", default = 100, help="number of points per toy", type=int)
    ...
    if args.npoints < 0:
        print "Number of points must be > 0. Defaulting to 100"
        args.npoints = 100
    ...
    moments = createToys(t, obsName, args.cut, args.npoints, args.ntoys)
