#!/bin/bash
set -x
#python top_mass_analysis.py --inDir /uscms_data/d1/msaunder/skims2017 -p ../Pileup/pileup_Sep16ReReco.root -j mt1715.json -o plots_mt1715 -n 17
python top_mass_analysis.py --inDir /uscms_data/d1/msaunder/skims2017 -p ../Pileup/pileup_combinedLumi_down.root -j mt1715.json -o plots_mt1715 -n 17
...
hadd -f mc_TT_mt1715.root mc_TT_mt1715_*
...
popd
python plotter.py -i plots_mt1715 -j mt1715.json -l 36000.0 
