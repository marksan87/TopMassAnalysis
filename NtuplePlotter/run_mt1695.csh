#!/bin/bash
set -x
python top_mass_analysis.py --inDir /uscms_data/d1/msaunder/skims2017 -p ../Pileup/pileup_processed_lumimasked.root -j mt1695.json -o plots_mt1695 -n 17
...
popd
python plotter.py -i plots_mt1695 -j mt1695.json -l 35862.0
