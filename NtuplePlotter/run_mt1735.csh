#!/bin/bash
set -x
#python top_mass_analysis.py --inDir /uscms_data/d1/msaunder/skims2017 -p ../Pileup/pileup_Sep16ReReco.root -j mt1735.json -o plots_mt1735 -n 17
python top_mass_analysis.py --inDir /uscms_data/d1/msaunder/skims2017 -p ../Pileup/pileup_combinedLumi_down.root -j mt1735.json -o plots_mt1735 -n 17
...
popd
python plotter.py -i plots_mt1735 -j mt1735.json -l 36000.0
