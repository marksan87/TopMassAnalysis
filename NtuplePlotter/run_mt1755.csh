#!/bin/bash
set -x
#python top_mass_analysis.py --inDir /uscms_data/d1/msaunder/skims2017 -p ../Pileup/pileup_Sep16ReReco.root -j mt1755.json -o plots_mt1755 -n 17
python top_mass_analysis.py --inDir /uscms_data/d1/msaunder/skims2017 -p ../Pileup/pileup_combinedLumi_down.root -j mt1755.json -o plots_mt1755 -n 17
source /cvmfs/cms.cern.ch/cmsset_default.csh

pushd plots_mt1755
hadd -f mc_DYJetsToLL.root mc_DYJetsToLL_*
hadd -f mc_ST_s.root mc_ST_s_*
hadd -f mc_ST_tW_antitop_mt1755.root mc_ST_tW_antitop_mt1755_*
hadd -f mc_ST_tW_top_mt1755.root mc_ST_tW_top_mt1755_*
hadd -f mc_ST_t_antitop.root mc_ST_t_antitop_*
hadd -f mc_ST_t_top.root mc_ST_t_top_*
hadd -f mc_TT_mt1755.root mc_TT_mt1755_*
...
popd
python plotter.py -i plots_mt1755 -j mt1755.json -l 36000.0 
