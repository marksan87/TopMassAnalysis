#!/bin/bash
set -x
python top_mass_analysis.py --inDir /uscms_data/d1/msaunder/skims2017 -p ../Pileup/pileup_processed_lumimasked.root -j mt1755.json -o plots_mt1755 -n 17
...
popd
python plotter.py -i plots_mt1755 -j mt1755.json -l 35862.0 
